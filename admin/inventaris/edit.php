...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM inventaris WHERE id_barang = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="merk" name="merk" value="<?= $row['merk'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="kode_aset" name="kode_aset" value="<?= $row['kode_aset'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="ket" class="col-sm-2 col-form-label">Tahun Perolehan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="tahun_perolehan" name="tahun_perolehan" value="<?= $row['tahun_perolehan'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="ket" class="col-sm-2 col-form-label">Sumber Dana</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="sumber_dana" name="sumber_dana" value="<?= $row['sumber_dana'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE inventaris SET 
        merk = '$merk', 
