...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM pegawai WHERE id_peg = '$id'");
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="golongan" name="golongan" value="<?= $row['golongan'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jk" class="col-sm-2 col-form-label">Jenis Kelamin</label>
                                            <div class="col-sm-10">
                                            <select class="form-control select2" data-placeholder="Pilih JK" id="jk" name="jk">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                            <select class="form-control select2" data-placeholder="Pilih Agama" id="agama" name="agama">
                                                    ...
                                                    <option value="Kongkuchu" <?php if ($row['agama'] == "Kongkuchu") {
                                                                                echo "selected";
                                                                            } ?>>Kongkuchu</option>
                                            </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="tmp_lhr" name="tmp_lhr" value="<?= $row['tmp_lhr'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="tgl_lhr" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="tgl_lhr" name="tgl_lhr" value="<?= $row['tgl_lhr'] ?>">
                                            </div>
                                        </div>  
