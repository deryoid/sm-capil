...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="tgl_terima" name="tgl_terima" value="<?= $row['tgl_terima']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="ket_surat" class="col-sm-2 col-form-label"> Keterangan Surat</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" class="form-control" id="ket_surat" name="ket_surat" readonly><?php echo $row['ket_surat']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('kepala/suratmasuk/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($submit) {
            $_SESSION['pesan'] = "Tanggapan Surat Masuk Ditanggapi";
