...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM surat_keluar WHERE id_sk = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Ubah Surat Keluar</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="tgl_kirim" name="tgl_kirim" value="<?= $row['tgl_kirim']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('kepala/suratkeluar/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE surat_keluar SET  
        ...
        if ($submit) {
            $_SESSION['pesan'] = "Tanggapan Surat Keluar Ditanggapi";
