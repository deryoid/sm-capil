        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Surat Perjalanan Dinas Dewan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Surat Perjalanan Dinas Dewan</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="edit?id=<?= $row['id_spd'] ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <label style="font-size: 15px; font-style: bold;">Berdasarkan Kategori</label>
                <form method="POST" target="blank" action="<?= base_url('user/spd/print.php') ?>">
                    <div class="row">
                        <div class="col-md-8">
